            ...
            <div class="row page-titles">
                <div class="col-12">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a href="<?= base_url('account-Type/add') ?>" class="btn btn-warning">+ Add</a>
                    </div>
                </div>
            </div>
                                            ...
                                            <?php if (!empty($data['all'])) : ?>
                                                ...
                                                foreach ($data['all'] as $item) : ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="">
                                                             <a href="<?= base_url('account-Type/edit/' . $item['id']) ?>" class="btn btn-primary" title="Edit"><i class="fa fa-edit"></i></a>

                                                                <a href="<?= base_url('account-Type/delete/' . $item['id']) ?>" class="btn btn-primary delete-btn" data-id="<?= $item['id'] ?>" title="<?= 'Delete'; ?>">
...
<script>
    Swal.fire({
        ...
        window.location.href = '<?= base_url('account-Type') ?>';
    });
</script>
